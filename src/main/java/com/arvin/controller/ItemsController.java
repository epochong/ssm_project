...
public class ItemsController {
    ...
    //商品列表查询
    @RequestMapping(value = "/modAllItemsList")
    public ModelAndView modAllItemsList(HttpServletResponse response,ItemsVO itemsVO) throws Exception{
        response.setContentType("text/html;charset=UTF-8");
        ...
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.addObject("itemsListKey",itemsCustomList);
        modelAndView.setViewName("modAllItems");
        return modelAndView;
    }
    ...
    @RequestMapping(value = "/modifyAllInfoShow")
    public String modifyAllInfoShow(Model model, HttpServletRequest request,
                                 HttpServletResponse response) throws  Exception{
        response.setContentType("text/html;charset=UTF-8");
    ...
    @RequestMapping(value = "/modAllSubmit")
    public String modifyAllInfoSubmit(ItemsVO itemsVO) throws Exception{
